...
import type { PermissionStatus as PermissionStatusType } from 'expo-modules-core';
import Alert from './alerts.web';

// Create a mock PermissionStatus enum since expo-modules-core is not available on web
...
let permissionStatus = {
  status: PermissionStatus.UNDETERMINED as any,
  expires: 'never',
  granted: false,
  canAskAgain: true,
};
...
export const requestPermissionsAsync = async () => {
  if ((permissionStatus.status as any) === PermissionStatus.GRANTED) {
      ...
      [
        {
          ...
          onPress: () => {
            permissionStatus = {
              status: PermissionStatus.DENIED as any,
              expires: 'never',
              granted: false,
              canAskAgain: true,
            };
        ...
        },
        {
          ...
          onPress: () => {
            permissionStatus = {
              status: PermissionStatus.GRANTED as any,
              expires: 'never',
              granted: true,
              canAskAgain: false,
            };
